...
const Header = () => {
  return (
      <header className="section rd-navbar-wrap rd-navbar-wrap-absolute" data-preset="">
          ...
          <div className="navbar-container">
            <div className="navbar-cell navbar-subpanel-contact">
              <div className="navbar-contact">
                <button className="navbar-button navbar-contact-btn" data-multi-switch=""><span></span></button>
                <div className="navbar-contact-body">
                  <div className="navbar-contact-title h4">Join My Newsletter</div>
                  <form className="rd-form rd-form-inline rd-mailform" data-form-output="newsletter-navbar" data-form-type="subscribe" method="post" action="components/rd-mailform/rd-mailform.php" noValidate="novalidate">
                    <div className="form-group">
                      <input className="form-control form-control-sm form-control-has-validation form-control-last-child" type="email" name="email" placeholder="E-mail" data-constraints="@Email @Required" id="regula-generated-984968" /><span className="form-validation"></span>
                    </div>
            ...
            <div className="navbar-cell navbar-cell-center ">
              <div className="navbar-panel ">
                ...
                <div className="navbar-logo"><a className="navbar-logo-link" href="index.html"><img className="navbar-logo-default" src="https://ld-wt73.template-help.com/wt_prod-29297/images/logo-default-228x67.png" alt="Booo" width="114" height="33" /><img className="navbar-logo-inverse" src="images/logo-inverse-228x67.png" alt="Booo" width="114" height="33" /></a></div>
              </div>
